...
ARCHITECTURE structure OF mux_4_to_1 IS
...
-- Equation(s):
-- \Mux0~0_combout\ = ( \sel[0]~input_o\ & ( \sel[1]~input_o\ & ( \A[3]~input_o\ ) ) ) # ( !\sel[0]~input_o\ & ( \sel[1]~input_o\ & ( \A[2]~input_o\ ) ) ) # ( \sel[0]~input_o\ & ( !\sel[1]~input_o\ & ( \A[1]~input_o\ ) ) ) # ( !\sel[0]~input_o\ & ( 
